...
if __name__ == "__main__":
    ...
    parser.add_argument('-noausaxs', '--disable_ausaxs', action='store_true', default=False,
                        help='include flag (no input) to disable the AUSAXS backend (pyausaxs) for the Debye calculation, and always use the default p(r)-based method.')
    ...
    for i in range(num_models):
        ...
        r, pr, pr_norm, dmax = calc_pr_best_func(point_distribution, prpoints=args.prpoints,
